            ...
            <div className="hero-content text-center text-white drop-shadow-md">
                <div className="max-w-2xl">
                    <h1 className="mb-5 text-5xl font-bold">TutorConnect,
                        Where <br />Learning Knows No Bounds.    </h1>
                    ...
                    <div>
                        ...
                        <a className="bg-[#00A5A7] hover:bg-[#008E90] text-white py-3 px-5 rounded-full border-none absolute right-28">Subscribe us</a>
                    </div>
